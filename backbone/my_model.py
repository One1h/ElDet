...
def DlaNet(num_layers=34, heads={'hm': 1, 'ab': 2, 'ang': 1, 'reg': 2, 'mask': 1}, head_conv=256, plot=False):
# def DlaNet(num_layers=34, heads={'hm': 1, 'ab': 2, 'ang': 1, 'reg': 2}, head_conv=256, plot=False):
